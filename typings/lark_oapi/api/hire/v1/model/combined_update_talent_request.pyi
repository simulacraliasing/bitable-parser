from .combined_update_talent_request_body import CombinedUpdateTalentRequestBody as CombinedUpdateTalentRequestBody
from lark_oapi.core.enum import AccessTokenType as AccessTokenType, HttpMethod as HttpMethod
from lark_oapi.core.model import BaseRequest as BaseRequest

class CombinedUpdateTalentRequest(BaseRequest):
    user_id_type: str | None
    request_body: CombinedUpdateTalentRequestBody | None
    def __init__(self) -> None: ...
    @staticmethod
    def builder() -> CombinedUpdateTalentRequestBuilder: ...

class CombinedUpdateTalentRequestBuilder:
    def __init__(self) -> None: ...
