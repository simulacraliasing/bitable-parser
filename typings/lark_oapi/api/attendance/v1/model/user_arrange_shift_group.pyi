from .arrange_shift_group import ArrangeShiftGroup as ArrangeShiftGroup
from lark_oapi.core.construct import init as init

class UserArrangeShiftGroup:
    user_id: str | None
    shift_group: ArrangeShiftGroup | None
    def __init__(self, d=None) -> None: ...
    @staticmethod
    def builder() -> UserArrangeShiftGroupBuilder: ...

class UserArrangeShiftGroupBuilder:
