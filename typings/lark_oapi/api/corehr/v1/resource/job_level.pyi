...
from ..model.patch_job_level_request import PatchJobLevelRequest as PatchJobLevelRequest
from ..model.patch_job_level_response import PatchJobLevelResponse as PatchJobLevelResponse
...
class JobLevel:
    ...
    def patch(self, request: PatchJobLevelRequest, option: RequestOption | None = None) -> PatchJobLevelResponse: ...
    async def apatch(self, request: PatchJobLevelRequest, option: RequestOption | None = None) -> PatchJobLevelResponse: ...
