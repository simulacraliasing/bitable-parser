...
from ..model.delete_app_role_request import DeleteAppRoleRequest as DeleteAppRoleRequest
from ..model.delete_app_role_response import DeleteAppRoleResponse as DeleteAppRoleResponse
...
class AppRole:
    ...
    def delete(self, request: DeleteAppRoleRequest, option: RequestOption | None = None) -> DeleteAppRoleResponse: ...
    async def adelete(self, request: DeleteAppRoleRequest, option: RequestOption | None = None) -> DeleteAppRoleResponse: ...
