...
from ..model.update_job_family_request import UpdateJobFamilyRequest as UpdateJobFamilyRequest
from ..model.update_job_family_response import UpdateJobFamilyResponse as UpdateJobFamilyResponse
...
class JobFamily:
    ...
    def update(self, request: UpdateJobFamilyRequest, option: RequestOption | None = None) -> UpdateJobFamilyResponse: ...
    async def aupdate(self, request: UpdateJobFamilyRequest, option: RequestOption | None = None) -> UpdateJobFamilyResponse: ...
