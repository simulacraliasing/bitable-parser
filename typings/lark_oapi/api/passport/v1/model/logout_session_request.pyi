from .logout_session_request_body import LogoutSessionRequestBody as LogoutSessionRequestBody
from lark_oapi.core.enum import AccessTokenType as AccessTokenType, HttpMethod as HttpMethod
from lark_oapi.core.model import BaseRequest as BaseRequest

class LogoutSessionRequest(BaseRequest):
    user_id_type: str | None
    request_body: LogoutSessionRequestBody | None
    def __init__(self) -> None: ...
    @staticmethod
    def builder() -> LogoutSessionRequestBuilder: ...

class LogoutSessionRequestBuilder:
    def __init__(self) -> None: ...
